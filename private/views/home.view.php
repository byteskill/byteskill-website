...
<div class="section-1">
	<div class="header-container">
		<div class="left">
			...
			<span class="subtitle">byte<invert-text>skill</invert-text> is an organization full of programmers who try toget out of their confort zone and build useful and efficient software.</span><br>
...
<div class="section-3">
	<div class="projects-container">
		...
		<div class="projects-right">
			<ul id="lightSlider">
				<li>
					<img src="https://picsum.photos/800/800" alt="Project A Preview Image">
					<h3>Project A</h3>
				...
				<li>
					<img src="https://picsum.photos/800/800" alt="Project B Preview Image">
					<h3>Project B</h3>
				...
				<li>
					<img src="https://picsum.photos/800/800" alt="Project C Preview Image">
					<h3>Project C</h3>
					<p>Lorem ipsum Cupidatat quis pariatur anim.</p>
					<form method="GET" action="#project-a">
						<input type="submit" value="More Information">	
				...
				<li>
					<img src="https://picsum.photos/800/800" alt="Project D Preview Image">
					<h3>Project D</h3>
					<p>Lorem ipsum Excepteur amet adipisicing fugiat velit nisi.</p>
					<form method="GET" action="#project-a">
						<input type="submit" value="More Information">	
				...
				<li>
					<img src="https://picsum.photos/800/800" alt="Project E Preview Image">
					<h3>Project E</h3>
					<p>Lorem ipsum Cupidatat quis pariatur anim.</p>
					<form method="GET" action="#project-a">
						<input type="submit" value="More Information">	
				...
				<li>
					<img src="https://picsum.photos/800/800" alt="Project F Preview Image">
					<h3>Project F</h3>
					<p>Lorem ipsum Excepteur amet adipisicing fugiat velit nisi.</p>
					<form method="GET" action="#project-a">
						<input type="submit" value="More Information">	
